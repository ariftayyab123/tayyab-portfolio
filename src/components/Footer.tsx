...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/ariftayyab123",
    icon: GitHubIcon,
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/tayyab-arif-24991123b?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    icon: LinkedInIcon,
  },
  {
    label: "Email",
          ...
          <div className="flex items-center gap-5">
            {socialLinks.map((link) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="rounded-lg p-2 text-gray-400 transition-colors duration-200 hover:text-white"
              >
